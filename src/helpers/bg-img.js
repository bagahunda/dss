module.exports = function(options) {
  ...
  var bg =
    '<table background="asset./assets/img/hero-header.jpg" align="center" class="wrapper bf-bg ' +
    classes +
    ' float-center" border="0" cellpadding="0" cellspacing="0" width="100%">\
			<tr valign="top">\
				<td background="' +
    src +
    '" bgcolor="' +
    bgcolor +
    '" valign="top" align="center" style="text-align: center; background-position: center center !important; background-size: cover !important;">\
					<!--[if gte mso 9]>\
